...
public class TitanHolefishEggData : BaseCreatureData
{
    public override TechType CreatureType { get; set; } = TechType.TitanHolefishEgg;

    public override bool IsCanBeAttacked { get; set; } = true;

    public override float Health { get; set; } = 250f;
